...
using _5032_Demo.Models;

namespace _5032_Demo.Controllers
{
    public class MOCK_DATAController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,medicine,number,price")] MOCK_DATA mOCK_DATA)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,medicine,number,price")] MOCK_DATA mOCK_DATA)
        {
            if (ModelState.IsValid)
            {
